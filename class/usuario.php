...
class Usuario {
	...
	public function login($login, $password){
		...
		$results = $sql->select("SELECT * FROM db_usuarios WHERE deslogin = :LOGIN AND dessenha= :PASSWORD", array(":LOGIN"=>$login,
			"PASSWORD"=>$password
	...
	public function update($login, $password){
		...
		$sql->query("UPDATE db_usuarios SET deslogin = :LOGIN, dessenha= :PASSWORD WHERE idsuario = :ID", array(
			':LOGIN'=>$this->getDeslogin(),
			':PASSWORD'=>$this->getDessenha(),
